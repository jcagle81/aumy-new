...
import { InfoContainer, InfoWrapper, InfoRow, Column1, Column2, TextWrapper,  Heading, Subtitle, ImgWrap, Img, ImgSm, Descr1, } from './SeniorElements';
 
const Senior = ({lightBg, id, imgStart, lightText, headline, darkText, description, img1,img2, img3, alt, info1, info2, info3, info4, info5, info6, info7, info8, info9}) => {
    return (
