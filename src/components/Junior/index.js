...
import { InfoContainer, InfoWrapper, InfoRow, Column1, Column2, TextWrapper,  Heading, Subtitle, ImgWrap, Img, ImgSm, Descr1, } from './JuniorElements';
 
const Junior = ({lightBg, id, imgStart, lightText, headline, darkText, description, img1,img2, img3, alt, info1, info2, info3, info4, info5, info6, info7, info8, info9}) => {
    return (
                ...
                <InfoWrapper>
                    <InfoRow imgStart={imgStart}>
                        ...
                        <TextWrapper>
                            ...
                            <Descr1 darkText={darkText}>{info9}</Descr1>
                            <ImgSm src={img3} />
                        </TextWrapper>
                        </Column1>
                        <Column2>
